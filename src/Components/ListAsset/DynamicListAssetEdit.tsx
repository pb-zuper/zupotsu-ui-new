...
// import { getLocalStorage } from 'apps/admin/src/utils/LocalStorageService';
...
import { Athlete, Content, Team, Tournament } from '../../assets';

const DynamicListAssetEdit = ({
  ...
  // useEffect(() => {
  //   dynamicListRef.current.onSaveDraft = async () =>
      // handleStep1Submit('published', false, false);
  // });
...
export default DynamicListAssetEdit;
